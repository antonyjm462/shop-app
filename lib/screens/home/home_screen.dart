...
class _BodyState extends State<Body> {
  // Use global lists directly from local_db_service.dart
  ...
  topCategoriesWidget(width, height) {
    return Container(
      ...
      width: width,
      height: 80, // Increased height for more prominent categories
                    ...
                    children: [
                      Container(
                        ...
                        constraints: BoxConstraints(
                          minWidth: 180, // Minimum width for card
                          minHeight: 200, // Minimum height for card
                        ),
                        decoration: BoxDecoration(
  ...
  lastCategoriesWidget(width, height) {
    int crossAxisCount = (width ~/ 220).clamp(2, 4); // Responsive columns: min 2, max 4
    return SizedBox(
      width: width,
      height: height / 1.8, // Make grid taller to fit more items
